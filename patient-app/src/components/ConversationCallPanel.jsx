...
export default function ConversationCallPanel({
  ...
  if (callState === "incoming") {
    return (
      <>
        ...
        <div className="fixed bottom-4 left-4 right-4 z-50 overflow-hidden rounded-3xl border border-slate-200 bg-white text-slate-900 shadow-2xl sm:bottom-6 sm:left-auto sm:right-6 sm:w-[22rem]">
  ...
  return (
    <div className="mb-4 overflow-hidden rounded-3xl bg-slate-950 text-white shadow-lg">
        ...
        <div className="relative aspect-video bg-slate-900">
          ...
          {localStream && (
            <video
              ...
              muted
              playsInline
              className="absolute bottom-3 right-3 h-20 w-28 rounded-2xl border border-white/20 bg-slate-900 object-cover shadow-xl sm:bottom-4 sm:right-4 sm:h-28 sm:w-40"
            />
          )}
        </div>
      ) : (
        <div className="flex h-64 flex-col items-center justify-center gap-4 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-800 sm:h-72">
      ...
      <div className="flex flex-col gap-4 bg-slate-900 px-4 py-4 sm:px-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
